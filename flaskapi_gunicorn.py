...
flood_clf = pickle.load(open('./weather-forecast-app/flood_model.sav', 'rb'))
rain_clf = pickle.load(open('./weather-forecast-app/rain_model.sav', 'rb'))

# LSTM model for rainfall (precipitation) prediction
